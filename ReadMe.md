...
- [jitsi](https://jitsi.org/projects/) - Jitsi Free & Open Source Video Conferencing Projects.
...
- [Open Data Hub](https://opendatahub.io/) - Open Data Hub is an open source AI platform designed for the hybrid cloud. The community seeks to bridge the gap between application developers, data stewards and data scientists by blending the leading open source AI tools with a unifying and intuitive user experience.
...
- [inventree](https://github.com/inventree/inventree) - InvenTree is an open-source Inventory Management System which provides powerful low-level stock control and part tracking. 
...
- [Devtron](https://github.com/devtron-labs/devtron/) - Kubernetes Dashboard for a Centralized DevOps Hub
